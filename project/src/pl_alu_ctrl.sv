...
module pl_alu_ctrl (
    ...
    always_comb begin
        case (ALUOp)
            ...
            2'b11: begin                // I-type arith: decodificar Funct3
                case (Funct3)
